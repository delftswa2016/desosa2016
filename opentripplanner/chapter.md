...
4. [Development View](#development)
   - [As-intended development view](#asintended)
   - [Layering violations](#layering)
   - [Technical debt](#debt)
5. [Features of OTP](#variability)
   - [System-wide features](#sfeatures)
   - [Graph build features](#gfeatures)
   - [Run-time features](#rfeatures)
   - [Relationships](#relationships)
   - [Feature model & binding time of features](#fmodel)
   - [Variability strategy](#variability)
...
OpenTripPlanner (OTP) [[4](#otpwebsite)] is an open-source software for multimodal trip planning and transportation network analysis that allow users to search for itineraries including pedestrian, bike, transit, and car components. The project is used as routing engine in both commercial and open source projects.
...
![Benefiters vs Developers, Users vs Providers](images-team-opentripplanner/companies.png) <br/>
...
#### As-intended Development View <div id="asintended"/>
OpenTripPlanner operates in two modes: as an instance running via Grizzly server (web server), which is suited for planning trips, and an analyst mode in which the complete network can be analyzed. Both of them refer to the same core: a routing Java library which is responsible for computing the multi modal transport trips. On top of this core, several services are built which call its internal functions [[11](#ua)].
...
![As-implemented development view](images-team-opentripplanner/DevelopmentView-violations.png) <br/> _Figure 5: Example of Layering violations in OTP_

### Technical debt in OTP <div id="debt"/>
To identify if there is technical debt in the system, the OTP project is evaluated in terms of the following 7 points [[12](#points)]: slowing velocity, stressful releases, aging libraries, defects, low automated test coverage, poor score on code quality metrics, presence of code smells
...
![code quality](images-team-opentripplanner/codesmell-overviewpyramid.png) <br/>
_Figure 6: Code quality of OTP_
...
![code smells](images-team-opentripplanner/codesmells.png) <br/>
_Figure 7: Presence of code smells_

Concluded can be that OTP project has technical debt (aging libraries, code quality metrics and defects), but most of it is managed [[14](#managed)]. Meaning releases are stable, not rushed and existing debt is paid off if needed. Fore example the defect for low-distance mode (issue 268) illustrates this: it was created in 2011, and fixed only recently.
...
#### 1. System-wide features <div id="sfeatures"/>
...
#### 2. Graph build features <div id="gfeatures"/>
...
#### 3. Run-time features <div id="rfeatures"/>
...
#### Relationships <div id="relationships"/>
...
_Figure 8: Variability options at the Visualizer_
...
#### Feature model & binding time of features <div id="fmodel"/>
...
#### Evolution history of variability mechanism <div id="evolution"/>
...
![Functional View](images-team-opentripplanner/functionalview.png) <br/>
_Figure 10: Functional View of OTP, showing how a request is handled_
...
![Translation process](images-team-opentripplanner/translation_process.png) <br/>
_Figure 11: Brief overview of the translation process_
...
1. <div id="book"/> Rozanski, N. & Woods, E. (2012). *Software systems architecture : working with stakeholders using viewpoints and perspectives.* Upper Saddle River, NJ: Addison-Wesley.
2. <div id="conveyal"/> Conveyal Consultancy Official Website 'http://conveyal.com' <br/>
3. <div id="google"/> - Google Groups Mailing Lists 'https://groups.google.com/forum/#!forum/opentripplanner-users' <br/>
4. <div id="otpwebsite"/> OTP's Official Website, 'http://docs.opentripplanner.org/en/latest/' <br/>
5. <div id="otpdoc"/> OTP's Documentation, 'http://docs.opentripplanner.org/en/latest/Deployments/#opentripplanner-deployments-worldwide' <br/>
6. <div id="sfc"/>Software Freedom Consservancy (SFC) Official Website 'http://sfconservancy.org/' <br/>
7. <div id="ttp"/>Trimet Trip Planner (https://ride.trimet.org/) <br/>
8. <div id="tpm"/> Trip Planner by Municipal Transport Company of Valencia 'http://www.emtvalencia.es/geoportal/?lang=en_otp'
9. <div id="his"/> http://www.opentripplanner.org/blog/2013/11/22/otp-joins-sfc/
10. <div id="dev"/> http://docs.opentripplanner.org/en/latest/Developers-Guide/#contributing-to-the-project
11. <div id="ua"/> http://docs.opentripplanner.org/en/latest/#basic-otp-architecture
12. <div id="points"/> https://18f.gsa.gov/2015/10/05/managing-technical-debt/
13. <div id="crunch"/> http://chadfowler.com/blog/2014/01/22/the-crunch-mode-antipattern/
14. <div id="managed"/> http://verraes.net/2013/07/managed-technical-debt/
